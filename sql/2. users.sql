...
(
    ...
    IS_ADMIN VARCHAR VARCHAR(16777216) DEFAULT 'N',
...
INSERT INTO DOC_AI_DB.SECURITY_SCHEMA.ORGANIZATIONS(ORGANIZATION_NAME, CREATED_BY, MODIFIED_BY) VALUES('Admin Corporation', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.SECURITY_SCHEMA.ORGANIZATIONS(ORGANIZATION_NAME, CREATED_BY, MODIFIED_BY) VALUES('Alpha Firm', CURRENT_USER(), CURRENT_USER());
...
INSERT INTO DOC_AI_DB.SECURITY_SCHEMA.USERS(ORGANIZATION_ID, USER_NAME, PASSWORD, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS, IS_ADMIN, CREATED_BY, MODIFIED_BY)
SELECT O.ID, 'ankur', 'password', 'Ankur', 'Patel', 'ankurcp@gmail.com', 'Y', CURRENT_USER(), CURRENT_USER()
FROM DOC_AI_DB.SECURITY_SCHEMA.ORGANIZATIONS O
WHERE O.ORGANIZATION_NAME = 'Admin Corporation'
;
...
SELECT O.ID, 'apatel', 'password', 'Ankur', 'Patel', 'ankurcpatel@hotmail.com', CURRENT_USER(), CURRENT_USER()
FROM DOC_AI_DB.SECURITY_SCHEMA.ORGANIZATIONS O
WHERE O.ORGANIZATION_NAME = 'Alpha Firm'
;
...
CREATE OR REPLACE VIEW DOC_AI_DB.SECURITY_SCHEMA.USERS_ORGANIZATIONS_VIEW AS
SELECT U.ID AS USER_ID, U.USER_NAME, U.PASSWORD, U.FIRST_NAME, U.LAST_NAME, U.EMAIL_ADDRESS, U.IS_ADMIN,
...
/*
SELECT * 
FROM DOC_AI_DB.SECURITY_SCHEMA.USERS_ORGANIZATIONS_VIEW
*/