...
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL(BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_DATABASE, SNOWFLAKE_MODEL_SCHEMA, SNOWFLAKE_MODEL_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('CM', 'Contract Model Batch', 'DOC_AI_STAGE', 'DOC_AI_DB', 'DOC_AI_SCHEMA', 'CONTRACTS_EXT', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL(BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_DATABASE, SNOWFLAKE_MODEL_SCHEMA, SNOWFLAKE_MODEL_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('IR', 'Inspection Report Batch', 'INSPECTION_STAGE', 'DOC_AI_DB', 'DOC_AI_SCHEMA', 'INSPECTION_REPORT_EXT', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL(BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_DATABASE, SNOWFLAKE_MODEL_SCHEMA, SNOWFLAKE_MODEL_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('IR2', 'Inspection Report Batch V2', 'BLAH_STAGE', 'DOC_AI_DB', 'DOC_AI_SCHEMA', 'BLAH_MODEL', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL(BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_DATABASE, SNOWFLAKE_MODEL_SCHEMA, SNOWFLAKE_MODEL_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('ACP', 'Ankur Magic Batch', 'BLAH_STAGE', 'DOC_AI_DB', 'DOC_AI_SCHEMA', 'BLAH_MODEL', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL(BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_DATABASE, SNOWFLAKE_MODEL_SCHEMA, SNOWFLAKE_MODEL_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('ACPN', 'Ankur Inactive Batch', 'BLAH_STAGE', 'DOC_AI_DB', 'DOC_AI_SCHEMA', 'BLAH_MODEL', 'N', CURRENT_USER(), CURRENT_USER());
...
SELECT BH.ID AS BATCH_HEADER_ID, BH.BATCH_HEADER_STATUS_CODE,  
    BH.BATCH_HEADER_MODEL_CODE, BHM.BATCH_HEADER_MODEL_LABEL,
    BHM.SNOWFLAKE_STAGE_NAME, BHM.SNOWFLAKE_MODEL_DATABASE, 
    BHM.SNOWFLAKE_MODEL_SCHEMA, BHM.SNOWFLAKE_MODEL_NAME,
    BHS.BATCH_HEADER_STATUS, BH.ORGANIZATION_ID, O.ORGANIZATION_NAME, 
    BH.USER_BATCH_NAME, BH.SYSTEM_BATCH_NAME, BH.BATCH_PATH, BD.ID AS BATCH_DETAIL_ID, BD.FILE_NAME, 
...
SELECT BATCH_HEADER_ID, BATCH_HEADER_STATUS_CODE, 
    ...
    BATCH_HEADER_STATUS, ORGANIZATION_ID, ORGANIZATION_NAME, 
...
GROUP BY BATCH_HEADER_ID, BATCH_HEADER_STATUS_CODE, 
    BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, 
    SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_DATABASE, 
    SNOWFLAKE_MODEL_SCHEMA, SNOWFLAKE_MODEL_NAME,
    BATCH_HEADER_STATUS, ORGANIZATION_ID, ORGANIZATION_NAME, 
