...
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL(BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('CM', 'Contract Model Batch', 'DOC_AI_STAGE', 'INSPECTION_REPORT_EXT', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL(BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('IR', 'Inspection Report Batch', 'INSPECTION_STAGE', '', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL(BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('IR2', 'Inspection Report Batch V2', 'BLAH_STAGE', 'BLAH_MODEL', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL(BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('ACP', 'Ankur Magic Batch', 'BLAH_STAGE', 'BLAH_MODEL', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL(BATCH_HEADER_MODEL_CODE, BATCH_HEADER_MODEL_LABEL, SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('ACPN', 'Ankur Inactive Batch', 'BLAH_STAGE', 'BLAH_MODEL', 'N', CURRENT_USER(), CURRENT_USER());
...
SELECT BH.ID AS BATCH_HEADER_ID, BH.BATCH_HEADER_STATUS_CODE,  
    ...
    BHM.SNOWFLAKE_STAGE_NAME, BHM.SNOWFLAKE_MODEL_NAME,
...
SELECT BATCH_HEADER_ID, BATCH_HEADER_STATUS_CODE, 
    ...
    SNOWFLAKE_STAGE_NAME, SNOWFLAKE_MODEL_NAME,
