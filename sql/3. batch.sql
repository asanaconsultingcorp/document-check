...
CREATE OR REPLACE TABLE DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE
(
    ID VARCHAR(16777216) PRIMARY KEY NOT NULL DEFAULT UUID_STRING(),
    BATCH_HEADER_MODEL_TYPE_CODE VARCHAR(16777216) UNIQUE ENFORCED,
    BATCH_HEADER_MODEL_TYPE_NAME VARCHAR(16777216),
...
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE(BATCH_HEADER_MODEL_TYPE_CODE, BATCH_HEADER_MODEL_TYPE_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('CM', 'Contract Model Batch', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE(BATCH_HEADER_MODEL_TYPE_CODE, BATCH_HEADER_MODEL_TYPE_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('IR', 'Inspection Report Batch', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE(BATCH_HEADER_MODEL_TYPE_CODE, BATCH_HEADER_MODEL_TYPE_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('IR2', 'Inspection Report Batch V2', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE(BATCH_HEADER_MODEL_TYPE_CODE, BATCH_HEADER_MODEL_TYPE_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('ACP', 'Ankur Magic Batch', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE(BATCH_HEADER_MODEL_TYPE_CODE, BATCH_HEADER_MODEL_TYPE_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('ACPN', 'Ankur Inactive Batch', 'N', CURRENT_USER(), CURRENT_USER());
...
(
    ...
    BATCH_HEADER_MODEL_TYPE_CODE VARCHAR(16777216),
...
SELECT BH.ID AS BATCH_HEADER_ID, BH.BATCH_HEADER_STATUS_CODE,  
    BH.BATCH_HEADER_MODEL_TYPE_CODE, BHMT.BATCH_HEADER_MODEL_TYPE_NAME, 
...
LEFT JOIN DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE BHMT ON BH.BATCH_HEADER_MODEL_TYPE_CODE=BHMT.BATCH_HEADER_MODEL_TYPE_CODE
...
SELECT BATCH_HEADER_ID, BATCH_HEADER_STATUS_CODE, BATCH_HEADER_STATUS, 
    BATCH_HEADER_MODEL_TYPE_CODE, BATCH_HEADER_MODEL_TYPE_NAME, 
    ORGANIZATION_ID, ORGANIZATION_NAME, BATCH_NAME, BATCH_PATH, 
