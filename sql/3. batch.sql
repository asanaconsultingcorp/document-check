...
CREATE OR REPLACE VIEW DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_DETAIL_ORGANIZATION AS
SELECT BH.ID AS BATCH_HEADER_ID, BH.ORGANIZATION_ID, O.ORGANIZATION_NAME, BH.BATCH_NAME, BH.BATCH_HEADER_STATUS_CODE, BHS.BATCH_HEADER_STATUS, 
    BH.CANCELLED_DATE, BH.PROCESSED_DATE, BH.CREATED_ON AS BATCH_CREATED_ON,
    BD.ID AS FILE_ID, BD.FILE_NAME, BD.FILE_TYPE, BD.FILE_SIZE
...
CREATE OR REPLACE VIEW DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_ORGANIZATION AS
SELECT BATCH_HEADER_ID, ORGANIZATION_ID, ORGANIZATION_NAME, BATCH_NAME, BATCH_HEADER_STATUS_CODE, BATCH_HEADER_STATUS, 
    CANCELLED_DATE, PROCESSED_DATE, BATCH_CREATED_ON, COUNT(FILE_ID) AS BATCH_COUNT
FROM DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_DETAIL_ORGANIZATION BHDO
GROUP BY BATCH_HEADER_ID, ORGANIZATION_ID, ORGANIZATION_NAME, BATCH_NAME, BATCH_HEADER_STATUS_CODE, BATCH_HEADER_STATUS, 
    CANCELLED_DATE, PROCESSED_DATE, BATCH_CREATED_ON
;
...
SELECT * FROM DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_ORGANIZATION
*/