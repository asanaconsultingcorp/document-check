...
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE(BATCH_HEADER_MODEL_TYPE_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('Contract Model Batch', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE(BATCH_HEADER_MODEL_TYPE_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('Inspection Report Batch', 'Y', CURRENT_USER(), CURRENT_USER());
INSERT INTO DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE(BATCH_HEADER_MODEL_TYPE_NAME, ACTIVE_FLAG, CREATED_BY, MODIFIED_BY) VALUES('TEST SHOULD NOT SHOW UP', 'N', CURRENT_USER(), CURRENT_USER());
...
(
    ...
    BATCH_HEADER_STATUS_CODE VARCHAR(16777216),
    BATCH_HEADER_MODEL_TYPE_ID VARCHAR(16777216),
...
SELECT BH.ID AS BATCH_HEADER_ID, BH.BATCH_HEADER_STATUS_CODE,  
    BH.BATCH_HEADER_MODEL_TYPE_ID, BHMT.BATCH_HEADER_MODEL_TYPE_NAME, 
...
LEFT JOIN DOC_AI_DB.STREAMLIT_SCHEMA.BATCH_HEADER_MODEL_TYPE BHMT ON BH.BATCH_HEADER_MODEL_TYPE_ID=BHMT.ID
...
SELECT BATCH_HEADER_ID, BATCH_HEADER_STATUS_CODE, BATCH_HEADER_STATUS, BATCH_HEADER_MODEL_TYPE_NAME, 
...
GROUP BY BATCH_HEADER_ID, BATCH_HEADER_STATUS_CODE, BATCH_HEADER_STATUS, BATCH_HEADER_MODEL_TYPE_NAME,
    ORGANIZATION_ID, ORGANIZATION_NAME, BATCH_NAME, BATCH_PATH, 
    CANCELLED_DATE, PROCESSED_START_DATE, PROCESSED_END_DATE, BATCH_CREATED_ON
;
