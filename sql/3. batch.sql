...
SELECT BH.ID AS BATCH_HEADER_ID, BH.BATCH_HEADER_STATUS_CODE, BHS.BATCH_HEADER_STATUS, BH.ORGANIZATION_ID, O.ORGANIZATION_NAME, 
    BH.BATCH_NAME, BH.BATCH_PATH, BD.ID AS FILE_ID, BD.FILE_NAME, 
...
SELECT BATCH_HEADER_ID, BATCH_HEADER_STATUS_CODE, BATCH_HEADER_STATUS, ORGANIZATION_ID, ORGANIZATION_NAME, 
    BATCH_NAME, BATCH_PATH, CANCELLED_DATE, PROCESSED_DATE, BATCH_CREATED_ON, COUNT(FILE_ID) AS BATCH_COUNT
...
GROUP BY BATCH_HEADER_ID, BATCH_HEADER_STATUS_CODE, BATCH_HEADER_STATUS, ORGANIZATION_ID, ORGANIZATION_NAME, 
    BATCH_NAME, BATCH_PATH, CANCELLED_DATE, PROCESSED_DATE, BATCH_CREATED_ON
;
